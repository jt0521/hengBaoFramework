...
public class XHeaderView extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        mLastRefreshTv = (TextView) findViewById(R.id.header_hint_lastRefreshTv);
    ...
    public void onChangStyle() {
        mHintTextView.setTextColor(context.getResources().getColor(android.R.color.white));
        mLastRefreshTv.setTextColor(context.getResources().getColor(android.R.color.white));
        mArrowImageView.setImageResource(R.drawable.ic_downgrey);
//        mProgressBar.setIndeterminateDrawable(context.getDrawable(R.drawable.progressbar_circle_grey));
    }
