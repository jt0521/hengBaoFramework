...
public class DialogUtil {
    ...
    public static Dialog getCenterDialog(Activity context, View view) {
        return DialogUtil.getCenterDialog(context, view, true);
    }
     ...
     * @return
     */
    public static Dialog getCenterDialog(Activity context, View view, boolean isFull) {
        ...
        int screenW = ScreenUtil.getScreenWH(context)[0];
        lp.width = isFull ? screenW : screenW * 3 / 4;
        return dialog;
    }
