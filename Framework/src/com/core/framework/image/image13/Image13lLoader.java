...
//        if(msgImgUrl==image.getTag())  return;
    ...
    public void loadNoStubImageFadeNewDefualt(String msgImgUrl, ImageView image) {
        image.setTag(msgImgUrl);
        if(msgImgUrl==null)return;
//        if(msgImgUrl==image.getTag())  return;
        imageLoader.displayImage(new DealUrl(msgImgUrl), image, getNoStubImageOptionsNew(),mAnimateFirstDisplayListener);
    }
...
//                .displayer(new FadeInBitmapDisplayer(FADE_IN_DURATION))
    ...
    private DisplayImageOptions getNoStubImageOptionsNew() {
        DisplayImageOptions.Builder builder =new DisplayImageOptions.Builder()
//                .showStubImage(R.drawable.img_list_default)
                .showImageOnFail(R.drawable.img_defualt)
                .showImageForEmptyUri(R.drawable.img_defualt)
